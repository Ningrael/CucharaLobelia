...
export default function Navbar({ currentView, setView, lang, translations }) {
  const items = [
    ...
    {
      id: 'battles',
      label: lang === 'es' ? 'Batallas' : 'Battles',
      icon: (
        <svg viewBox="0 0 24 24">
          <path d="M14.5 13.5L11 10l3.5-3.5L13 5l-5 5 5 5 1.5-1.5zM6.5 10.5L10 14l-3.5 3.5L8 19l5-5-5-5-1.5 1.5z"/>
        </svg>
      )
    },
    {
